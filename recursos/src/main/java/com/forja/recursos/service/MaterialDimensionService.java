...
public class MaterialDimensionService {
    ...
    public List<MaterialDimension> buscarPorIds(List<Integer> materialDimensionIds) {
    ...
    public void vincularEquipamientoAMateriales(Integer equipamientoId, List<Integer> nuevosMaterialIds) {
        ...
        List<MaterialDimension> materialesAntiguos = materialDimensionRepository.findByEquipamientoId(equipamientoId);
        ...
        materialDimensionRepository.saveAll(materialesAntiguos);
        materialDimensionRepository.saveAll(nuevosMateriales);
    }

    public List<Integer> obtenerIdsPorEquipamiento(Integer equipamientoId) {
        List<MaterialDimension> materiales = materialDimensionRepository.findByEquipamientoId(equipamientoId);
