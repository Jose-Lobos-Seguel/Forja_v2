...
public class Runa {
    ...
    @Column(nullable = true, length = 50)
    @Size(min = 2, max = 50, message = "El bonus debe contener entre 2 y 50 caracteres")
    @NotBlank
    //Bonus que brinda la runa
    //Puede ser NULL
    //NULL indica que la runa no tiene elemento
    ...
    private List<EquipamientoRunaEntidad> equipamientos = new ArrayList<>();
}
