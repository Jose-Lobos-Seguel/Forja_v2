...
public class EquipamientoService {
    ...
    public EquipamientoDTO actualizar(Integer id, EquipamientoDTO equipamientoActualizado) {
        ...
        {
            materialClient.vincularMaterialesAEquipamiento(equipamiento.getId(), equipamientoActualizado.getMaterialDimensionIds());
        }
    ...
    if (equipamiento.getForjador_id() != null) 
    {
        ...
        try {
            EnanoDTORemoto forjadorRemoto = enanoClient.buscarPorId(equipamiento.getForjador_id());
    ...
    public Equipamiento convertirEntidad(EquipamientoDTO dto) {
        ...
        {
            List<MaterialDimensionDTORemoto> materialesDto = materialClient.obtenerMaterialesPorIds(dto.getMaterialDimensionIds());
        ...
        {
            entidad.setForjador_id(enanoClient.buscarPorId(dto.getForjadorId()).getId());
        }
        return entidad;
    }
